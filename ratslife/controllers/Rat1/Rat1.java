...
public class Rat1 extends Robot {
  ...
  protected final double[] collisionAvoidanceWeights = {0.0,0.0,0.015,0.045,-0.045,-0.015,0.0,0.0};
  
  //protected final double[] slowMotionWeights = {0.0125,0.00625,0.0,0.0,0.0,0.0,0.00625,0.0125};
  protected final double[] slowMotionWeights = {0.0,0.0,0.0,0.0094,0.0094,0.0,0.0,0.0};
  ...
  public void run() {
    ...
    while (step(timeStep) != -1) {
      ...
      boolean rightSideSen = distance[5]+distance[4] < 500;
      boolean frontWall = distance[3]+distance[4] > 750;
